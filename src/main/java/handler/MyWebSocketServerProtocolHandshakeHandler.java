                ...
                handshakeFuture.addListener(new ChannelFutureListener() {
                    ...
                    public void operationComplete(ChannelFuture future) throws Exception {
                        if (!future.isSuccess()) {
                            ...
                            // websocket 握手成功之后，将用户 channel 加入到 UserSesssionDirectory
                            Channel channel = ctx.channel();
                            QueryStringDecoder qsd = new QueryStringDecoder(req.uri());
                            channel.attr(AttributeKeyDirectory.USERID).set(qsd.parameters().get("userId").get(0));
                            channel.attr(AttributeKeyDirectory.CHATNAME).set(qsd.parameters().get("chatName").get(0));
                            UserSesssionDirectory.group.add(channel);
                        }
                    }
                });
